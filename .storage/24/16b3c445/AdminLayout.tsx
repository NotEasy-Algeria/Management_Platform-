...
const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      href: '/admin/children',
      icon: Baby,
      current: location.pathname === '/admin/children'
    },
    {
      name: 'Documents',
    ...
    },
    {
      ...
      icon: Users,
      current: location.pathname === '/admin/educators',
      adminOnly: true
    },
    {
      name: 'Planning',
    ...
    },
    {
      ...
      href: '/admin/expenses',
      icon: DollarSign,
      current: location.pathname === '/admin/expenses',
      adminOnly: true
    },
    {
      name: 'Paiements',
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center px-6 py-4 border-b">
        ...
        <Badge className="ml-2 bg-pink-100 text-pink-800 text-xs">
